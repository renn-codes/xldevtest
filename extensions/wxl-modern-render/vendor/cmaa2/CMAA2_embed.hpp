// Generated from CMAA2.hlsl - do not edit; regenerate via gen_embed.py.
// Embedded as separate raw-string array elements (MSVC string-literal limits); join to recover.
#pragma once

namespace wxl::scripts::render_modern
{
    inline const char* const k_cmaa2_parts[] = {
R"WXEMBED(///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
R"WXEMBED(    lpfloat3 color = g_inColorMSReadonly.Load( int4( pixelPos, sampleIndex, 0 ), offset ).rgb;
#else
...
R"WXEMBED(lpfloat ComputeLocalContrastH( int x, int y, in lpfloat2 neighbourhood[4][4] )
{
    // new, small kernel 4-connecting-edges-only local contrast adaptation
...
R"WXEMBED(            lpfloat2 leftColumn     = g_groupShared2x2FracEdgesV[ centerAddr2x2 - 1 ].yw;              // left column's right edge
...
R"WXEMBED(            // bottom   becomes     right
...
//#endif
    ...
    inline constexpr int k_cmaa2_partCount = 6;
}
